...
object LedFunction {
    ...
    val effects = listOf(
        ...
        LedEffect("Звёздное дитя", "EFF:25"),
        LedEffect("Фейерверк (микрофон)", "EFF:26"),
        LedEffect("Визуалайзер (микрофон)", "EFF:27"),
        LedEffect("Огонь (микрофон)", "EFF:28"),
        LedEffect("Смена цветов (микрофон)", "EFF:29"),
        LedEffect("Радужное переливание (микрофон)", "EFF:30"),
        LedEffect("Переливание под музыку (микрофон)", "EFF:31"),
        LedEffect("Звёздное дитя (микрофон)", "EFF:32")
    )
}